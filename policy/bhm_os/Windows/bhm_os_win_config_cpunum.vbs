'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'' FILENAME:     bhm_os_win_config_cpunum.vbs
'' VERSION:      1.0
'' DESCRIPTION:  The script can be used to check  number of cpu and compare with  last time.
''               
'' USAGE:        cscript bhm_os_win_config_cpunum.vbs
''               
'' LANGUAGE:     VBScript
''
...
FilePath = OvDataDirStr & "\bhm\bhm_OsConfig_cpunum.txt"  
...
If rezult <> 0 Then
	wscript.echo  "cpu  number change"
	
	msg_text = "number of cpu had been changed ,last:" & lastconfig & " current:" &currconfig
	msg_app = "bhm_os_win_config_cpunum.vbs"
