...
#usage: osspi_perl.sh  bhm_os_hpux_config_cpufrequency.pl 
...
#HPUX#HPUX#HPUX#HPUX#HPUX#HPUX#HPUX#HPUX#HPUX#HPUX#HPUX#HPUX#
...
sub  SendMsg
{
	...
	my $app='bhm_os_hpux_config_cpufrequency.pl';
	my $obj="cpu";
...
sub  getCurr
{
	...
	{
		&SendMsg("normal","open /usr/contrib/bin/machinfo fail because $!");
		return 0;
	}
}
...
our $bhm_os_hpux_config_file = ${bhm_os_hpux_config_dir}."/"."bhm_OsConfig_cpufrequency.txt";
...
unless($flag)
{	
		&SendMsg("warning","cpu frequency had been changed last:${Last} ; \ncurrent:${Curr} ");
