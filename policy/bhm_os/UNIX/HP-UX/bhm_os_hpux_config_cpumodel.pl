...
#usage: osspi_perl.sh  bhm_os_hpux_config_cpumodel.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_hpux_config_cpumodel.pl';
	my $obj="cpu";
...
sub  getCurr
{
	...
	{
		&SendMsg("normal","execute /usr/contrib/bin/machinfo fail because $!");
		return 0;
	}
}
...
our $bhm_os_hpux_config_file = ${bhm_os_hpux_config_dir}."/"."bhm_OsConfig_cpumodel.txt";
