...
#usage: osspi_perl.sh  bhm_os_hpux_config_manufacturer.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_hpux_config_manufacturer.pl';
	my $obj="manufacturer";
...
sub  getCurr
{
	...
	{
		&SendMsg("normal","invoke machinfo commad fail,because $!");
		return 0;
	}
}
...
our $bhm_os_hpux_config_file = ${bhm_os_hpux_config_dir}."/"."bhm_OsConfig_manufacturer.txt";
