...
#usage: osspi_perl.sh  bhm_os_linux_config_cpufrequency.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_linux_config_cpufrequency.pl';
	my $obj="cpu";
...
our $bhm_os_linux_config_file = ${bhm_os_linux_config_dir}."/"."bhm_OsConfig_cpufrequency.txt";
