...
#usage: osspi_perl.sh  bhm_os_linux_config_filesystemname.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_linux_config_filesystemname.pl';
	my $obj="filesystem";
...
our $bhm_os_linux_config_file = ${bhm_os_linux_config_dir}."/"."bhm_OsConfig_filesystemname.txt";
