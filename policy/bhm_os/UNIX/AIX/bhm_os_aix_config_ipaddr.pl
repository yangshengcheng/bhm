...
#usage: osspi_perl.sh  bhm_os_aix_config_ipaddr.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_aix_config_ipaddr.pl';
	my $obj="ipaddress";
...
our $bhm_os_aix_config_file = ${bhm_os_aix_config_dir}."/"."bhm_OsConfig_ipaddr.txt";
