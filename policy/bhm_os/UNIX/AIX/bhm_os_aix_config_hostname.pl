...
#usage: osspi_perl.sh  bhm_os_aix_config_hostname.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_aix_config_hostname.pl';
	my $obj="hostname";
...
our $bhm_os_aix_config_file = ${bhm_os_aix_config_dir}."/"."bhm_OsConfig_hostname.txt";
