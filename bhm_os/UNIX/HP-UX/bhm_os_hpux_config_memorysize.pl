...
#usage: osspi_perl.sh  bhm_os_hpux_config_memorysize.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_hpux_config_memorysize.pl';
	my $obj="memory";
...
our $bhm_os_hpux_config_file = ${bhm_os_hpux_config_dir}."/"."bhm_OsConfig_memorysize.txt";
...
unless($flag)
{	
		&SendMsg("warning","memory size  had been changed last:${Last} ; \ncurrent:${Curr} ");
