...
#usage: osspi_perl.sh  bhm_os_linux_config_hostname.pl 

#parameter: none

#description: check  hostname config 
...
sub  SendMsg
{
	...
	my $app='bhm_os_linux_config_hostname.pl';
	my $obj="hostname";
...
sub  getCurr
{
	...
	{
		&SendMsg("normal","invoke hostname commad fail");
		return 0;
	}
}
...
our $bhm_os_linux_config_file = ${bhm_os_linux_config_dir}."/"."bhm_OsConfig_hostname.txt";
...
unless($flag)
{	
		&SendMsg("warning","hostname had been changed last:${Last}; \ncurrent:${Curr}");
