...
#usage: osspi_perl.sh  bhm_os_linux_config_manufacturer.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_linux_config_manufacturer.pl';
	my $obj="manufacturer";
...
our $bhm_os_linux_config_file = ${bhm_os_linux_config_dir}."/"."bhm_OsConfig_manufacturer.txt";
