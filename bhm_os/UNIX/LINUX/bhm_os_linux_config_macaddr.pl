...
#usage: osspi_perl.sh  bhm_os_linux_config_macaddr.pl 
...
sub  SendMsg
{
	...
	my $app='bhm_os_linux_config_macaddr.pl';
	my $obj="macaddress";
...
our $bhm_os_linux_config_file = ${bhm_os_linux_config_dir}."/"."bhm_OsConfig_macaddr.txt";
