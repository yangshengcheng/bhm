'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'' FILENAME:     bhm_os_win_config_cpumodel.vbs
'' VERSION:      1.0
'' DESCRIPTION:  The script can be used to check  model of cpu and compare with  last time.
''               
'' USAGE:        cscript bhm_os_win_config_cpumodel.vbs
''               
'' LANGUAGE:     VBScript
''
...
FilePath = OvDataDirStr & "\bhm\bhm_OsConfig_cpumodel.txt"  
...
If rezult <> 0 Then
	wscript.echo  "cpu  model change"
	
	msg_text = "model of cpu had been changed ,last:" & lastconfig & " current:" &currconfig
	msg_app = "bhm_os_win_config_cpumodel.vbs"
